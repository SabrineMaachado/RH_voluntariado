...
var quizSet = new QuizSet(document.getElementById("quiz-set"));

var InitScorm = function InitScorm() {
...
MakeResize(ResizeHelper(1280, 720), {
  fontSize: 20
});
...
var makeBulets = function makeBulets() {
  var sectionsChildrens = jQuery.makeArray($(".sections"));
  ...
  for (var i = 0; i < sectionsChildrens.length; i++) {
    ...
    $(".navegacao").append("<a class='" + classe + "' href='#" + sectionAtual.id + "'><li></li></a>");
  }
};

var checkBullet = function checkBullet(element) {
  var arrBulles = jQuery.makeArray($(".page-scroll"));
